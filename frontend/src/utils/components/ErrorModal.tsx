  ...
  const content = (
    <>
      ...
      >
        ...
        {/*--- content ---*/}
        <div className="flex-1 min-h-0 px-6 pt-6 pb-8 ortrait:sm:px-[32px] landscape:lg:px-[32px] desktop:!px-[48px] overflow-y-auto thinScrollbar textBaseApp">
          <FaTriangleExclamation className="mx-auto text-5xl text-textRed" />
