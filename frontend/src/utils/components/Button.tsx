...
export default function Button({
  ...
  return (
    <button
      {...props}
      className={`flex-none font-semibold flex items-center justify-center gap-1 desktop:cursor-pointer disabled:cursor-default select-none ${variants[variant]} ${sizes[size]} ${className}`}
