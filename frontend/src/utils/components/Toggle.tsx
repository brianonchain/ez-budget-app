export default function Toggle({ checked, onClick }: { checked: boolean | undefined; onClick?: any }) {
  return (
    <div className="w-[56px] h-[30px] desktop:w-[46px] desktop:h-[25px] flex items-center relative cursor-pointer" onClick={onClick}>
      ...
      <div className="w-[25px] h-[25px] desktop:w-[21px] desktop:h-[21px] absolute left-[3px] desktop:left-[2px] peer-checked:translate-x-full rounded-full bg-lightBg1 dark:bg-darkText1 transition-all pointer-events-none"></div>
    </div>
  );
}
