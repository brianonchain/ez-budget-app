...
export default function DetailsCalendar({
  ...
  return (
    <>
      ...
      <div className="z-[1] absolute right-0 top-[calc(100%+0.25rem)] px-2 py-2 desktop:py-1 rounded-lg bg-input1Bg border-[1.5px] border-input1BorderFocus">
        <DayPicker
          className="textSmApp"
          classNames={{
            ...
            chevron: `${defaultClassNames.chevron} w-4 h-4 fill-text1`,
            weekday: "",
            ...
            selected: `${defaultClassNames.selected} bg-button1Bg text-button1Text`,
