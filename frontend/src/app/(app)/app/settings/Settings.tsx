...
export default function Settings({ provider, email }: { provider: string; email: string }) {
  ...
  return (
    <div className="appPageContainer relative" style={{ scrollbarGutter: "stable" }}>
      {/* --- glow --- */}
      <div className="z-0 absolute inset-0 pointer-events-none glowDark" aria-hidden>
        <div className="absolute top-1/2 right-0 translate-y-[-50%] translate-x-[50%] w-[90%] h-[50%] glowDarkInner" />
      </div>
      {/*--- content ---*/}
