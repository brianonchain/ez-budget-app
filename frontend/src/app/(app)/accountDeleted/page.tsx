...
export default function AccountDeletedPage() {
  return (
    <div className="relative px-6 w-full min-h-screen flex flex-col items-center justify-center text-center">
      ...
      <p className="mt-6 text-xl opacity-80">Your EZ Budget account has been permanently removed.</p>

      <Link className="mt-12 text-xl desktop:text-base link" href="/login">
