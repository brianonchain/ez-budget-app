  ...
  return (
    <>
      <div className="bg-lightBg2 dark:bg-darkBg1 text-lightText1 dark:text-darkText1 min-h-screen flex flex-col gap-[12px] mx-auto p-8">
        ...
        <p>
          When you sign in with Google, we collect your basic profile
          information. Specifically, we collect your name, your email address,
          and your profile picture.
        </p>

        <h2 className="font-bold">How We Use Your Information</h2>
        <p>
          We use your information to authenticate your account. We do not share
          your information with any third parties.
        </p>

        <h2 className="font-bold">Data Retention</h2>
        <p>
          We retain your basic profile information only while your account is
          active.
        </p>
      ...
      <div className="rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm dark:border-neutral-800 dark:bg-neutral-950">
        ...
        <div className="mt-8 space-y-10">
          <Section title="1. Description of Service">
            <p>
              {appName} is a budgeting web application designed to help users
              manage personal financial information entered by the user.
            </p>
            <p>
          ...
          <Section title="2. Accounts">
            <p>
              You sign in using a valid Google account. You are responsible for
              maintaining the confidentiality of your account access.
            </p>
          </Section>
          ...
          <Section title="4. Data Accuracy">
            <p>
              You are responsible for the accuracy of any budgeting or financial
          ...
          <Section title="7. Disclaimer">
            <p>
              {appName} does not provide financial, legal, or tax advice. Any
          ...
          <Section title="8. Limitation of Liability">
            <p>
              ...
              liable for any damages arising from or related to your use of the
              service.
            </p>
          </Section>
          ...
          <Section title="10. Governing Law">
            <p>
              These Terms are governed by the laws of your applicable
              jurisdiction.
            </p>
          </Section>
